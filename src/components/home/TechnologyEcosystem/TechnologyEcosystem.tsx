...
export function TechnologyEcosystem() {
  return (
    <Section variant="white" className="pt-2 md:pt-4 pb-14 md:pb-20 overflow-hidden">
      <Container>
        {/* Light Tinted Rounded Container */}
        <div className="bg-[#f8fafd] border border-slate-100/90 rounded-[28px] md:rounded-[40px] py-12 md:py-14 px-5 md:px-10 max-w-7xl mx-auto shadow-[0_4px_30px_-10px_rgba(8,30,66,0.03)]">
          
          {/* Header Content */}
          <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10 md:mb-12">
            <Eyebrow className="justify-center mb-3.5">BUILT WITH MODERN TECHNOLOGIES</Eyebrow>

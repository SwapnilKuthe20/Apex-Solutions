...
export function Hero() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full min-h-[auto] md:min-h-[85vh] lg:min-h-[92vh] xl:min-h-[95vh] flex items-center bg-white overflow-x-clip "
    >
      <Container className="relative z-10 w-full h-full max-w-[1400px] px-6 lg:px-10">
        <div className="flex flex-col lg:flex-row h-full items-center justify-between gap-10 lg:gap-4 xl:gap-8">
          ...
          <div className="w-full lg:w-[45%] flex flex-col justify-center h-full order-2 lg:order-1 mt-0 lg:mt-0 relative z-20">
            <HeroContent
